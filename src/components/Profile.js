      ...
      <form  onSubmit={submitHandler} >
       <div className="profile">
        ...
        <div id="profile-secondrow">
          ...
          <input className="string optional" maxLength="255" value={password}  onChange={(e) => setPassword(e.target.value)} id="user-password" placeholder="Mật khẩu cũ" type="password" size="50"/>
          <label className="string optional" for="user-name" >Xác nhận mật khẩu mới</label>
          <input className="string optional" maxLength="255" value={confirmPassword}  onChange={(e) => setConfirmPassword(e.target.value)} id="user-newPassword" placeholder="Mật khẩu mới" type="password" size=" 50"/>
        </div>
      </div>
